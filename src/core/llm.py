...
_MODEL_TABLE = {
    ...
    SberModelName.GIGACHAT: "gigachat"
}

ModelT: TypeAlias = (
    ChatOpenAI | ChatAnthropic | ChatGoogleGenerativeAI | ChatGroq | ChatBedrock | ChatOllama | GigaChat
)
...
def get_model(model_name: AllModelEnum, /) -> ModelT:
    ...
    if model_name in SberModelName:
        return GigaChat(credentials='MGYyOWIxYWQtYjE0OC00OGQwLThhNzEtYzI4NjZmMTRkMGU4OjMxOWU3YTczLTIxNWEtNGRlNy1iMGYyLWQzNzU2ZGRmOTZiMw==', scope="GIGACHAT_API_PERS", model="GigaChat-Max", verify_ssl_certs=False, profanity_check=False, top_p=0)
